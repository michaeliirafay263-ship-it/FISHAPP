...
export function OrdersPipeline() {
  const { orders, riders, updateOrderStatus, assignRider } = useAdminData();
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
        <div>
          <h2 style={{ fontSize: '1.3rem', fontWeight: '800', color: 'var(--color-navy)' }}>
            Order Pipeline & Dispatch Operations
          </h2>
          <p style={{ fontSize: '0.85rem', color: 'var(--color-text-subtle)' }}>
            Manage order workflow from Kivukoni Market pier sourcing to rider handover and customer doorstep.
          </p>
        </div>
            ...
            <div key={order.id} className="card" style={{ padding: '20px' }}>
              <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: '12px', marginBottom: '14px' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontSize: '1.3rem', fontWeight: '800', color: 'var(--color-navy)' }}>
              ...
              {/* Items in this order */}
              <div style={{ backgroundColor: 'var(--color-surface-hover)', padding: '12px 14px', borderRadius: 'var(--radius-md)', marginBottom: '14px' }}>
                <div style={{ fontSize: '0.75rem', fontWeight: '700', color: 'var(--color-text-subtle)', marginBottom: '6px', textTransform: 'uppercase' }}>
